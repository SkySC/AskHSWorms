...
class ProfileActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        btn_update.setOnClickListener {
            ...
            var afterUpdate = User(
                ...
                input_password_new.toString() , "" , ""
            )

            ordersRef?.setValue(afterUpdate)
            Toast.makeText(baseContext , "Profildaten aktuallisiert" , Toast.LENGTH_LONG).show()
        }
    ...
    private fun uploadProfileBild(
        ...
        val ref =
            currentUserStorage.child("ProfileBild/${UUID.nameUUIDFromBytes(selectedImageBytes)}")
        ...
        ref.putBytes(selectedImageBytes).addOnCompleteListener {
            if (it.isSuccessful) {
                ...
                Toast.makeText(
                    this , "Error: ${UUID.nameUUIDFromBytes(selectedImageBytes)} " ,
                    Toast.LENGTH_LONG
                ).show()
            }
        }
